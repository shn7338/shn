...
$fullStats = 'D:\桌面\dac\04_simulation\sionna\dac_sionna_35ghz_depth8_27360_v3\stage2a_residual_stats_train.json'
$smokeStats = 'D:\桌面\dac\04_simulation\sionna\dac_sionna_35ghz_depth8_27360_v3\stage2a_residual_stats_smoke512.json'
...
switch ($Mode) {
    ...
    'Smoke' {
        ...
        $smokeOutput = "D:\桌面\dac\03_runs\E_stage\dac_stage2a_sionna35_depth8_paper_smoke_$stamp"
